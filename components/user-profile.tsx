  ...
  return (
    <div className="max-w-4xl mx-auto p-8 bg-gradient-to-br from-indigo-50 via-purple-50 to-pink-50 rounded-lg border border-gray-200 transition-all duration-300 hover:shadow-xl">
      ...
      <p className="text-gray-700 mb-8 leading-relaxed text-center md:text-left animate-fade-in">
        ...
        Wisconsin-Madison, majoring in Computer Science. I'm an explorer of new
        tech, an avid learner, and a problem-solver at heart. Moreover, I'm a
        passionate programmer on earth. Feel free to connect with me for all
        things tech or just to say hello! Let's shape the future of tech
        together. 🌟
      </p>
