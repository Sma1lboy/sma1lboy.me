...
const CLASSIC_WORDS = [
  ...
  "porta", "nibh", "venenatis", "cras", "semper", "auctor", "neque",
  "vitae", "lectus", "urna", "duis", "convallis", "tellus",
  "sagittis", "eu", "volutpat", "odio", "facilisis", "mauris",
  "nunc", "pulvinar", "sapien", "pellentesque", "habitant", "morbi",
  "tristique", "senectus", "netus", "malesuada", "fames", "ac",
  "turpis", "egestas", "pharetra", "massa", "ultricies", "mi",
  "quis", "hendrerit", "gravida", "rutrum", "quisque", "faucibus",
...
const PROGRAMMER_WORDS = [
  "refactor", "deploy", "commit", "merge", "branch", "rebase", "sprint",
  "standup", "backlog", "endpoint", "middleware", "callback", "promise",
  "async", "await", "runtime", "compiler", "parser", "token", "buffer",
  "stack", "heap", "queue", "cache", "proxy", "daemon", "socket",
  "thread", "mutex", "semaphore", "pipeline", "container", "cluster",
  "instance", "schema", "migration", "query", "index", "shard",
  "replica", "payload", "header", "request", "response", "status",
  "timeout", "retry", "fallback", "throttle", "debounce", "hook",
  "state", "props", "render", "component", "module", "package",
  "import", "export", "interface", "generic", "abstract", "virtual",
  "override", "static", "const", "mutable", "volatile", "nullable",
  "boolean", "integer", "string", "array", "object", "function",
  "lambda", "closure", "iterator", "generator", "decorator", "mixin",
  "singleton", "factory", "observer", "adapter", "facade", "strategy",
  "template", "prototype", "builder", "resolver", "handler", "service",
  "controller", "repository", "gateway", "config", "environment",
  "variable", "parameter", "argument", "return", "exception", "error",
  "debug", "breakpoint", "assertion", "benchmark", "profile",
  "optimize", "minify", "bundle", "transpile", "lint", "format",
];

const PROGRAMMER_FIRST =
  "Refactor deploy commit merge branch, rebase sprint async.";
      ...
      <div className="container mx-auto max-w-2xl px-6 py-10 sm:px-8 sm:py-14">
        ...
        >
          <motion.div
            ...
            className="max-h-80 overflow-y-auto whitespace-pre-wrap text-sm leading-relaxed text-gray-900 dark:text-gray-100"
          >
            {text}
          </motion.div>
